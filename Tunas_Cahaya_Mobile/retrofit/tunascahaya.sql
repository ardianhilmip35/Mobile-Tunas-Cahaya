...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 01 Jan 2022 pada 03.24
...
('K004', 'Masjid Al-Hidayah', 'Masjid', 'projects1.jpg', 'Masjid', 'Jember');
...
(39, 'Ardian Hilmi Pramulintang', 'ardi@gmail.com', '085236814716', 'ardi1234', 'jember'),
(40, 'starlord12', 'starlord12@gmail.com', '081249721948', 'starlord12', '');
...
--
ALTER TABLE `tb_user`
  MODIFY `id_pelanggan` tinyint(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=41;
